...
TEST_CASE("json_object") {
  ...
  Json vec_obj = vec_op;
  // if (vec_obj.as_collection<int>() != root["arr from
  // vec"].as_collection<int>()) {
  //     std::cerr << "error: " << root["arr from vec"].as_string() <<
  ...
  //     std::cerr << "error: " << root["obj from map"].as_string() <<
  //     std::endl; return false;
  // }
  //
  ...
  //
  // bool is_int_map = root["obj from map"].is_object() && root["obj from
  // map"].all<int>(); if (!is_int_map) {
  //     std::cerr << "not all int: " << root["obj from map"].as_string() <<
  //     std::endl; return false;
  // }
